...
<template>
  <div class="page-shell">
    <form @submit.prevent class="w-full">
      ...
      <!-- Breadcrumb & Title -->
      <div class="crumb">
        <span>เล่มหลักสูตร</span> › <b>หมวดที่ 5</b>
      ...
      <div class="toc-card">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-[4px_18px]">
          <div v-for="(title, i) in sectionTitles" :key="i" class="toc-item" :class="{ 'filled': doneState[i] }" @click="scrollToSec(`sec-5-${i+1}`)">
      ...
      <div class="paper-card">
        ...
        <section v-for="(title, i) in sectionTitles" :key="i" :id="`sec-5-${i+1}`" class="topic-sec">
          
          <div class="sec-head">
            <div class="sec-number">5.{{ i + 1 }}</div>
